...
function phorum_htmlpurifier_save_settings()
{
    ...
    if (phorum_htmlpurifier_config_file_exists()) {
        echo "Cannot update profile, <code>mods/htmlpurifier/config.php</code> already exists. To change
        profile, edit that file. To use the web form, delete that file.<br />";
    } else {
